...
As Ted Sanders mentioned in [this HN comment](https://news.ycombinator.com/item?id=41174306), using strict mode bears a significant cold start penalty which goes away in the subsequent runs.
