---
title: Benchmarking LLM for Structured JSON Generation - A Comprehensive Analysis (Aug 2024)
...
3. gpt-4o-2024-08-06 generating JSONs using Tool Calls
4. gpt-4o-2024-08-06 generating JSONs using JSON mode
5. gpt-4o-2024-08-06 generating JSONs using JSON mode using strict mode
6. gpt-4o-mini generating JSONs using JSON mode using strict mode
...
- For the mini model, strict mode was generally cheaper (e.g., $0.0060 vs $0.0115 for Wide JSON)
...
3. **For Highly Complex JSON**:
   ...
   - Implement strategies to mitigate cold start impacts (e.g., keep-warm functions)
